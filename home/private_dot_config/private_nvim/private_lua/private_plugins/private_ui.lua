...
return {
    ...
    -- provides the base colorscheme for the editor environment as well as third-party plugins.
    {
        'catppuccin/nvim',
        name = 'catppuccin',
        priority = 1000,
    ...
    -- provides general syntax highlighting for most languages and config files. Also provides
    -- usefull keymaps for navigating around based on 'textobjects'.
    {
        ...
        opts = {
            ensure_installed = {
                ...
                'gomod', 'gosum', 'gpg', 'html', 'java', 'javascript', 'json', 'julia',
                'kotlin', 'latex', 'lua', 'make', 'markdown_inline', 'pug', 'python', 'regex',
                'rust', 'sql', 'ssh_config', 'tmux', 'tmux', 'toml', 'typescript', 'vim',
                'xml', 'yaml',
            },
            auto_install = false,
            highlight = {
    ...
    -- Git Markers --
    -- provides visual markers for git related changes. Also provides useful keymaps for staging
    -- and toggling blames for specific portions of the file.
    {
